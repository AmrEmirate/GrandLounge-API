/*
  ...
  - You are about to drop the column `midtransOrderId` on the `Booking` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "public"."Booking" DROP COLUMN "midtransOrderId",
